...
- [ ] **Inference pause/resume around training adds latency** - verify `BlockingTacticModel.pause()` actually drains in-flight batches before training begins. [nanoproof/rl.py:523-561](nanoproof/rl.py#L523-L561), [nanoproof/inference.py:247-263](nanoproof/inference.py#L247-L263)
